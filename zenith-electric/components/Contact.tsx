...
function Contact() {
  return (
    <section id="contact" className="py-16 bg-[#0b0e14] border-t border-green-500/10 relative overflow-hidden">
      ...
      <div className="absolute right-0 top-0 w-1/3 h-full bg-green-500/[0.01] -skew-x-12 translate-x-1/2 pointer-events-none"></div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6 items-start group">
                ...
                <div>
                  ...
                  <p className="text-sm text-white font-light tracking-wide hover:text-green-400 transition-colors">projects@zenithelectric.cm</p>
                </div>
              </div>
