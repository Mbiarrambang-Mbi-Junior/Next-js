...
import ChadashAutomation from './ChadashAutomation'
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2 text-white group cursor-default">
              ...
              <span className="text-lg tracking-tighter uppercase italic">
                Chadash<span className="text-green-500">Automation</span>
              </span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-[11px] font-light">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="hover:text-green-400 transition-colors cursor-pointer tracking-wide text-green-500/60">projects@ChadashAutomation.com</span>
              </li>
            </ul>
          </div>
